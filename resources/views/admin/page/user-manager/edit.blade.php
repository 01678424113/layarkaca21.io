                            ...
                            <form action="{{ route('user-admin.update', $model->id) }}" method="post"
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="name" required value="{{$model->username}}" disabled class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input name="password" type="password" class="form-control" autocomplete="off" placeholder="Chỉ nhập nếu bạn muốn đổi mật khẩu"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input name="password_confirmation" type="password" class="form-control" placeholder="Chỉ nhập nếu bạn muốn đổi mật khẩu"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input name="email" type="text" required class="form-control" disabled value="{{$model->email}}"/></div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input name="phone" type="text" required class="form-control" value="{{$model->phone}}"/></div>
                                    </div>
                                    <div class="form-group">
